    ...
    methods: {
        ...
        init_data() {
            ...
            let z = y
                console.clear()
            taxa_levels.map((tl) => {
                let names = Array.from(new Set(this.speciesData.map((sd) => sd[`taxon_${tl}_name`])))
            ...
            // this.newickData = "(((((Thelacantha_brevispina))Thelacantha,((Argiope_aemula))Argiope,((Nephila_pilipes))Nephila)Araneidae)Araneoidea,((((Myrmaplata_plataleoides))Myrmaplata)Salticidae)Salticoidea,((((Poecilotheria_regalis))Poecilotheria)Theraphosidae))Arachnida;"
            // (((((Thelacantha_brevispina))Thelacantha,((Argiope_aemula))Argiope,((Nephila_pilipes))Nephila)Araneidae)Araneoidea,((((Myrmaplata_plataleoides))Myrmaplata)Salticidae)Salticoidea,((((Poecilotheria_regalis))Poecilotheria)Theraphosidae))Arachnida;
